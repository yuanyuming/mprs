...
# CONFIG
server = '210.43.0.195'
username='161402100218'#学号
password='19980114'#密码
CONTROLCHECKSTATUS = b'\x20'
ADAPTERNUM = b'\x03'
host_ip = '172.20.63.77'
IPDOG = b'\x01'
host_name = 'GILIGILIEYE'
PRIMARY_DNS = '210.43.0.8'
dhcp_server = '172.20.63.254'
AUTH_VERSION = b'\x28\x00'
mac = 0x0026c70cf4d2
host_os = 'NOTE7'
...
nic_name = 'eth0' #Indicate your nic, e.g. 'eth0.2'.nic_name
bind_ip = '0.0.0.0'
